...
class viewUseElecTable extends StatefulWidget {
  // final list;
  // final i;
  // final x;
  String mon_Start;
  ...
  viewUseElecTable(String mon_Start, mon_End, yaerSave) {
  ...
  //   return _viewUseElecTableState(mon_Start);
  // }
  _viewUseElecTableState createState() =>
      _viewUseElecTableState(mon_Start, mon_End, yaerSave);
}

class _viewUseElecTableState extends State<viewUseElecTable> {
  String mon_Start;
  String mon_End;

  String yaerSave;
  _viewUseElecTableState(String mon_Start, mon_End, yaerSave) {
    this.mon_Start = mon_Start;
    this.mon_End = mon_End;
  ...
  Future<List> getDataToTable() async {
    final response = await http.get(Uri.parse(
        'http://$ipcon/greenhousegas/show_eg_elec_table.php?eg_year=${yaerSave}&mon_Start=${mon_Start}&mon_End=${mon_End}'));
    //print(response.body);
