...
class industrialpollution extends StatefulWidget {
  @override
  _industrialpollutionState createState() => _industrialpollutionState();
}

class _industrialpollutionState extends State<industrialpollution> {
  @override
  void initState() {
    //getsubname();
    super.initState();
            ...
            Center(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text("บันทึกข้อมูลมลพิษกากอุสาหกรรมA",
                        style: TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                            color: Colors.white)),
                        ...
                        Form(
                            ...
                            child: Column(
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(
                                      right: 160, top: 15, bottom: 5),
                                  child: Text("กรอกปริมาณกาก",
                                      style: TextStyle(
                                          fontSize: 16,
                                          color: Colors.grey[700])),
                                ),
                                ...
                                Padding(
                                  ...
                                  child: Text("ประเภทรถที่ใช้ขนส่ง",
                                      style: TextStyle(
                                          fontSize: 16,
                                          color: Colors.grey[700])),
                                ),
