...
class addwaterr extends StatefulWidget {
  @override
  _addwaterrState createState() => _addwaterrState();
}

class _addwaterrState extends State<addwaterr> {
  @override
  void initState() {
    //getsubname();
    super.initState();
            ...
            Center(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text("บันทึกข้อมูลมลพิษน้ำA",
                        style: TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                            color: Colors.white)),
