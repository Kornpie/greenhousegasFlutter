...
Future main() async {
  ...
  runApp(
      MaterialApp(home: lpgChartRaw(mon_Start, mon_End, yearSave)));
}
        ...
        child: ElevatedButton(
            onPressed: () async {
              await widget.browser.open(
                  url: Uri.parse(
                      "http://$ipcon/greenhousegas/Chart/chartRawshow_lpg.php?mon_start=${mon_Start}&mon_end=${mon_End}&year=${yearSave}"),
