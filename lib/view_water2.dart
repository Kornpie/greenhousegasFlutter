...
import 'package:greenhousegas/show_water2_chart.dart';
...
import 'package:greenhousegas/view_table_water2.dart';
...
class viewwater2 extends StatefulWidget {
  final list;
  final dataMonth;
  final i;
  final x;
  viewwater2({this.list, this.i, this.x, this.dataMonth});
  @override
  _viewwater2State createState() => _viewwater2State();
}

class _viewwater2State extends State<viewwater2> {
  ...
  Future uploaddata() async {
    ...
    if (sum >= 2) {
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  viewtablewater2(mon_Start, mon_End, yearSave)));
    } else {
      ArtSweetAlert.show(
          context: context,
  ...
  Future gochart() async {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => water2Chart(mon_Start, mon_End, yearSave)));
  }
                            ...
                            child: Column(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text("ข้อมูลการใช้น้ำอ่อน " + '',
                                      style: TextStyle(
                                          fontSize: 16,
