...
import 'package:greenhousegas/view_table_use_ng.dart';
...
class UseNGData extends StatefulWidget {
  final list;
  final dataMonth;
  final i;
  final x;
  UseNGData({this.list, this.i, this.x, this.dataMonth});
  @override
  _UseNGDataState createState() => _UseNGDataState();
}

class _UseNGDataState extends State<UseNGData> {
  ...
  Future uploaddata() async {
    ...
    if (sum >= 2) {
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  UseNGDataTable(mon_Start, mon_End, yaerSave)));
    } else {
      ArtSweetAlert.show(
          context: context,
