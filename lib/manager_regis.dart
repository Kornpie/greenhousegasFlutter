...
class managerregis extends StatefulWidget {
  @override
  managerregisState createState() => managerregisState();
}

class managerregisState extends State<managerregis> {
  @override
  void initState() {
    getsubname();
    super.initState();
