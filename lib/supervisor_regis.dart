...
class supervisorregis extends StatefulWidget {
  @override
  supervisorregisState createState() => supervisorregisState();
}

class supervisorregisState extends State<supervisorregis> {
  @override
  void initState() {
    getcompany();
    super.initState();
