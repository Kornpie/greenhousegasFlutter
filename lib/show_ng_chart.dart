...
class ngChartRaw extends StatefulWidget {
  ...
  // Strin;
  String yearSave;
  ngChartRaw(String mon_Start, mon_End, yearSave) {
  ...
  @override
  _ngChartRawState createState() =>
      new _ngChartRawState(mon_Start, mon_End, yearSave);
}

class _ngChartRawState extends State<ngChartRaw> {
  String mon_Start;
  String mon_End;
  // Strin;
  String yearSave;
