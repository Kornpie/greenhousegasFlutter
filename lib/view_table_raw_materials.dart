...
class viewTable extends StatefulWidget {
  ...
  viewTable(String mon_Start, mon_End, yaerSave, selectedValue) {
  ...
  //   return _viewTableState(mon_Start);
  // }
  _viewTableState createState() =>
      _viewTableState(mon_Start, mon_End, selectedValue, yaerSave);
}
...
class _viewTableState extends State<viewTable> {
  ...
  String selectedValue;
  String yaerSave;
  _viewTableState(String mon_Start, mon_End, selectedValue, yaerSave) {
    this.mon_Start = mon_Start;
    this.mon_End = mon_End;
    this.selectedValue = selectedValue;
    this.yaerSave = yaerSave;
  ...
  Future<List> getDataToTable() async {
    ...
    final response = await http.get(Uri.parse(
        'http://$ipcon/greenhousegas/show_raw_table.php?raw_yaer=${yaerSave}&mon_Start=${mon_Start}&mon_End=${mon_End}&comid=${selectedValue}'));
    //print(response.body);
