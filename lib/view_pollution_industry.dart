...
class viewpollutionindustry extends StatefulWidget {
  final list;
  final dataMonth;
  final i;
  final x;
  viewpollutionindustry({this.list, this.i, this.x, this.dataMonth});
  @override
  _viewpollutionindustryState createState() => _viewpollutionindustryState();
}

class _viewpollutionindustryState extends State<viewpollutionindustry> {
            ...
            Center(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text("แสดงข้อมูลมลพิษอุสาหกรรมA",
                        style: TextStyle(
                            fontSize: 20,
                            ...
                            child: Column(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text("ข้อมูลมลพิษอุสาหกรรมA " + '',
                                      style: TextStyle(
                                          fontSize: 16,
