...
class viewpollutionwater extends StatefulWidget {
  final list;
  final dataMonth;
  final i;
  final x;
  viewpollutionwater({this.list, this.i, this.x, this.dataMonth});
  @override
  _viewpollutionwaterState createState() => _viewpollutionwaterState();
}

class _viewpollutionwaterState extends State<viewpollutionwater> {
