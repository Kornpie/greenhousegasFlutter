...
class addwater2 extends StatefulWidget {
  final list;
  final i;
  final x;
  addwater2({this.list, this.i, this.x});
  @override
  _addwater2State createState() => _addwater2State();
}

class _addwater2State extends State<addwater2> {
  ...
  String monSave = null;
  String yeaSave = null;
  TextEditingController watername =
      TextEditingController(text: "การใช้น้ำประปาอ่อน");
            ...
            Center(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text("เพิ่มข้อมูลการใช้น้ำอ่อน",
                        style: TextStyle(
                            fontSize: 20,
