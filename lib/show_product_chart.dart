...
class productChartRaw extends StatefulWidget {
  ...
  String selectedValue;
  String yearSave;
  productChartRaw(String mon_Start, mon_End, yearSave, selectedValue) {
  ...
  @override
  _productChartRawState createState() =>
      new _productChartRawState(mon_Start, mon_End, selectedValue, yearSave);
}

class _productChartRawState extends State<productChartRaw> {
  String mon_Start;
  String mon_End;
  String selectedValue;
  String yearSave;
  _productChartRawState(String mon_Start, mon_End, selectedValue, yearSave) {
    this.mon_Start = mon_Start;
    this.mon_End = mon_End;
    this.selectedValue = selectedValue;
    this.yearSave = yearSave;
