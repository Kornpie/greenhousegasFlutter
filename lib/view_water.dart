...
import 'package:greenhousegas/show_water1_chart.dart';
...
class viewwater extends StatefulWidget {
  final list;
  final dataMonth;
  final i;
  final x;
  viewwater({this.list, this.i, this.x, this.dataMonth});
  @override
  _viewwaterState createState() => _viewwaterState();
}

class _viewwaterState extends State<viewwater> {
  ...
  Future gochart() async {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => water1Chart(mon_Start, mon_End, yearSave)));
  }
                            ...
                            child: Column(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text("ข้อมูลน้ำประปาการนิคมฯ " + '',
                                      style: TextStyle(
                                          fontSize: 16,
