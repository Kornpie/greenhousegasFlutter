...
class addwater3 extends StatefulWidget {
  ...
  final i;
  final x;
  addwater3({this.list, this.i, this.x});
  @override
  _addwater3State createState() => _addwater3State();
}
...
class _addwater3State extends State<addwater3> {
  ...
  String monSave = null;
  String yeaSave = null;
  TextEditingController watername = TextEditingController(text: "การใช้น้ำRO");
  ...
  Future geteq() async {
    final response = await http.get(Uri.parse(
        "http://${ipcon}/greenhousegas/getfactors.php?nameFac=tapwater-RO"));
    if (response.statusCode == 200) {
            ...
            Center(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text("เพิ่มข้อมูลการใช้น้ำRO",
                        style: TextStyle(
                            fontSize: 20,
